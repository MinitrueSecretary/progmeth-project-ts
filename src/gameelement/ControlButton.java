...
public class ControlButton extends Button implements Highlightable {
	private Border border;
	private Border transparentBorder;
	
	public ControlButton(String title) {
		super(title);
	...
	//"Challenge" and "Showdown" is too long for 28px size Text
	public void setButtonStyleSmallFont() {
		this.setStyle("-fx-background-color: \r\n"
				+ "        #000000,\r\n"
				+ "        linear-gradient(#7ebcea, #2f4b8f),\r\n"
				+ "        linear-gradient(#426ab7, #263e75),\r\n"
